...
void RpgGame::Draw() {
	...
	aDrawableConsole.draw(ATTACK_CENTER_X - 6, ATTACK_CENTER_Y + 4, (GETENEMYINFO[opponent].name+"の命").c_str());//敵体力
	...
	aDrawableConsole.draw(ATTACK_CENTER_X + 3, ATTACK_CENTER_Y + 4, "春の命");
