...
namespace  roguegame {
	...
	static const vector<data> DETAILS = {
		...
		{ true,"”~"    ,Ai_AttackMy	   ,  10,{ 0},{ 7, 4, 3,  5} },//t‚Ì‰Ô
		{ true,"ä¿"    ,Ai_AttackMy    ,  20,{ 0},{10, 5, 4, 10} },
		{ true,"’Ö"    ,Ai_AttackMy    ,  30,{ 0},{20, 9, 5, 20} },
		{ true,"÷"	   ,Ai_AttackMy    ,  50,{ 0},{30, 8, 6, 30} },

		{ true,"—¨"    ,Ai_AttackMy    ,  60,{ 0},{20, 9, 9, 60} },//‰Ä‚Ì‰Ô
		{ true,"ˆ¨"    ,Ai_AttackMy    ,  70,{ 0},{10,20, 5, 70} },
		{ true,"å["    ,Ai_AttackMy    ,  30,{ 0},{30,15,30, 80} },
