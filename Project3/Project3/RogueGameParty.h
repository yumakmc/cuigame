...
namespace  roguegame {
	...
	static const vector<data> DETAILS = {
		{ false,"春",10,5,0,Ai_Controlabel },
		{ false,"夏",1000,50,0,Ai_AttackSpring },
		{ false,"秋",100,30,0,Ai_AttackSummer },
		{ false,"冬",100,10,0,Ai_AttackEnemy },
		{ true,"嵐",10,1,5,Ai_AttackMy },
		{ true,"小隕石",1000,50 ,10,Ai_AttackMy },
		{ true,"中隕石",100,30,20,Ai_AttackMy },
		{ true,"大隕石",10,10,50,Ai_AttackMy },
