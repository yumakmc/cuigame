...
namespace  roguegame {
	...
	static const vector<data> DETAILS = {
		...
		{ false,"‰Ä"   ,Ai_AttackSpring,1000,{20},{ 0, 0, 0, 10} },
		...
		{ true,"÷"	   ,Ai_AttackMy    ,  40,{ 0},{40, 8, 9, 40 } },

		{ true,"—¨"    ,Ai_AttackMy    ,  50,{ 0},{25, 10, 3, 50} },//‰Ä‚Ì‰Ô
		{ true,"ˆ¨"    ,Ai_AttackMy    ,  60,{ 0},{35,11, 1, 60} },
		{ true,"å["    ,Ai_AttackMy    ,  20,{ 0},{30,25,5, 20} },
		{ true,"˜@"    ,Ai_AttackMy	   , 100,{ 0},{50,14,17,100} },
